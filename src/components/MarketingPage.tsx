...
import { getQRCodes, deleteQRCode, getScansForQRCode } from "@/utils/qrRedirect";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Create and track QR codes for physical posters
            </p>
          </div>
        </div>
      ...
      {qrCodesWithStats.length > 0 ? (
              ...
              <div className="w-full h-64 bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center">
                {qr.imageUrl ? (
                  ...
                  <div className="text-center p-8">
                    ...
                    <p className="text-xs text-muted-foreground">Poster Preview</p>
                  </div>
                )}
              </div>
        ...
        <div className="flex flex-col items-center justify-center py-24 px-4">
          ...
          <p className="text-sm text-muted-foreground text-center max-w-md mb-6">
            Create your first QR code to start tracking poster performance.
          </p>
          <Button onClick={() => setShowCreateModal(true)}>
            <Plus className="w-4 h-4 mr-2" />
            Create QR Code
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              undone. All scan data will be preserved.
            </DialogDescription>
          </DialogHeader>
