  ...
  if (!profileCompleted) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-2">Sign in to view your events</h2>
  ...
  return (
    <div
      className={`bg-white border rounded-lg p-4 transition-all hover:shadow-sm ${
        isPast ? "opacity-60 border-gray-200" : "border-gray-200 hover:border-gray-300"
      }`}
    >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">{event.organization}</p>
            </div>
          ...
          <div className="flex items-center gap-1.5 mt-2 text-xs text-gray-500">
            ...
            {!isRegistered && (
              <span className="ml-2 px-1.5 py-0.5 bg-gray-100 text-gray-600 rounded text-[10px] font-medium">
                Saved
              </span>
            )}
          </div>
          ...
          {!isPast && (
            <div className="flex items-center gap-2 mt-3">
              {isRegistered ? (
                <>
                  <button className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-gray-100 text-gray-700 rounded hover:bg-gray-200 transition-colors">
