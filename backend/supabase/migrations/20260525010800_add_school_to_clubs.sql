...
SELECT 'U of T Computer Science Student Union', '["Academic", "Technology"]'::jsonb, 'https://cssu.ca', 'cssu_uoft', 'cssu_discord', 'Independent', 'University of Toronto'
WHERE NOT EXISTS (SELECT 1 FROM public.clubs WHERE club_name = 'U of T Computer Science Student Union');

INSERT INTO public.clubs (club_name, categories, club_page, ig, discord, club_type, school)
SELECT 'U of T Board Games Club', '["Social & Games"]'::jsonb, 'https://uoftboardgames.ca', 'uoftboardgames', 'uoftboardgames', 'Independent', 'University of Toronto'
WHERE NOT EXISTS (SELECT 1 FROM public.clubs WHERE club_name = 'U of T Board Games Club');

INSERT INTO public.clubs (club_name, categories, club_page, ig, discord, club_type, school)
SELECT 'McGill Computer Science Undergraduate Society', '["Academic", "Technology"]'::jsonb, 'https://csusmcgill.ca', 'csus_mcgill', 'csus_mcgill', 'Independent', 'McGill University'
WHERE NOT EXISTS (SELECT 1 FROM public.clubs WHERE club_name = 'McGill Computer Science Undergraduate Society');

INSERT INTO public.clubs (club_name, categories, club_page, ig, discord, club_type, school)
SELECT 'McGill Board Games Club', '["Social & Games"]'::jsonb, 'https://mcgillboardgames.ca', 'mcgillboardgames', 'mcgillboardgames', 'Independent', 'McGill University'
WHERE NOT EXISTS (SELECT 1 FROM public.clubs WHERE club_name = 'McGill Board Games Club');

INSERT INTO public.clubs (club_name, categories, club_page, ig, discord, club_type, school)
SELECT 'UBC Computer Science Student Society', '["Academic", "Technology"]'::jsonb, 'https://ubccsss.ca', 'ubccsss', 'ubccsss', 'Independent', 'University of British Columbia'
WHERE NOT EXISTS (SELECT 1 FROM public.clubs WHERE club_name = 'UBC Computer Science Student Society');

INSERT INTO public.clubs (club_name, categories, club_page, ig, discord, club_type, school)
SELECT 'UBC Board Games Club', '["Social & Games"]'::jsonb, 'https://ubcboardgames.ca', 'ubcboardgames', 'ubcboardgames', 'Independent', 'University of British Columbia'
WHERE NOT EXISTS (SELECT 1 FROM public.clubs WHERE club_name = 'UBC Board Games Club');

INSERT INTO public.clubs (club_name, categories, club_page, ig, discord, club_type, school)
SELECT 'McMaster Computer Science Society', '["Academic", "Technology"]'::jsonb, 'https://mcmastercss.ca', 'mcmastercss', 'mcmastercss', 'Independent', 'McMaster University'
WHERE NOT EXISTS (SELECT 1 FROM public.clubs WHERE club_name = 'McMaster Computer Science Society');

INSERT INTO public.clubs (club_name, categories, club_page, ig, discord, club_type, school)
SELECT 'McMaster Board Games Club', '["Social & Games"]'::jsonb, 'https://mcmasterboardgames.ca', 'mcmasterboardgames', 'mcmasterboardgames', 'Independent', 'McMaster University'
