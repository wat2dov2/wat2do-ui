...
from services.wat2do import image_uploader
from services.wat2do.image_uploader import _is_safe_image_url
...
def test_https_instagram_cdn_allowed():
    with patch("services.wat2do.image_uploader.socket.getaddrinfo", _mock_addrinfo):
...
def test_metadata_service_rejected_even_if_host_allowlisted(monkeypatch):
    ...
    with patch("services.wat2do.image_uploader.socket.getaddrinfo", _mock_addrinfo_private):
