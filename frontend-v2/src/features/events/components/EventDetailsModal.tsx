...
export function EventDetailsModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={modalState.handleOpenChange}>
      <DialogContent className="paper-note max-h-[90vh] max-w-2xl overflow-y-auto border-0 p-0">
        {displayedEvent && (
          <>
            <div className="relative h-64 w-full overflow-hidden border-b border-black/10">
              <LazyImage
            ...
            <ModalContentWrapper>
              <DialogHeader>
                <DialogTitle className="font-[Georgia,Times,serif] text-xl">{displayedEvent.title}</DialogTitle>
