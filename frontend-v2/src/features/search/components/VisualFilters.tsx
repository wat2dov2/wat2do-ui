      ...
      >
        <div className="relative">
          <button
            ...
            className="bg-muted font-medium text-foreground text-xs px-3 py-2.5 rounded-xl w-full text-left hover:bg-secondary transition-colors flex items-center justify-between cursor-pointer"
          >
            <span>
              {filters.selectedCategories.length > 0
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="bg-muted text-foreground text-xs px-3 py-1.5 rounded-xl hover:bg-secondary transition-colors flex items-center gap-1.5"
            >
